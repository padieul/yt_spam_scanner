...
def train_svm_classifier(features, labels, vect):
    ...
    save_model(svm_clf, vect) # save model to disk
...
if __name__ == "__main__":
    ...
    train_svm_classifier(tfidf_voc, np.asarray(corpus["CLASS"]),tfidf_vectorizer)
