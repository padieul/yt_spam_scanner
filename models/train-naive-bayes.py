...
def train_nb_classifier(features, labels, vect):
    ...
    save_model(nb_clf, vect) # save model to disk
...
if __name__ == "__main__":
    ...
    #time.sleep(3)
    train_nb_classifier(tfidf_voc, np.asarray(corpus["CLASS"]), tfidf_vectorizer)
